...
export const commentPost = (comment, id) => API.patch(`/posts/commentPost/${id}`, comment)
...
export const editPassword = (passwords, id) => API.patch(`/user/editPassword/${id}`, passwords)
